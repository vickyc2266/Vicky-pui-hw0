...
class Roll {
    ...
    //     const glazingOption = glazingOptions.find(option => option.option === this.glazing);
    //     // console.log(glazingOption);
    //     const packSizeOption = packSizeOptions.find(size => size.amount === this.size);
    //     // console.log(packSizeOption);

    //     // if (!glazingOption || !packSizeOption) {
    //     //     console.error('Invalid glazing or pack size.');
    //     //     return 0; // or handle this scenario appropriately
    //     // }
    //     const glazingAddOn = glazingOption.addOn;
    //     // console.log(glazingAddOn);
    //     const packMultiplier = packSizeOption.add;
    //     // console.log(packMultiplier);
